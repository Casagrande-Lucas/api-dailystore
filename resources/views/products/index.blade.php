        ...
        <table class="table">
            ...
            @forelse($products->items() as $product)
                <tr id="productRow_{{ $product->id }}">
                    ...
                    <td id="total-column">R$ {{ number_format(($product->amount * $product->value), 2, ',', '.') }}</td>
                    <td>
                        <a id="btn-add-item" class="btn btn-success" onclick="fastSetAmountButton('{{ $product->id }}', true)">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                                <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
                            </svg>
                        </a>
                        <a id="btn-rm-item" class="btn btn-danger @if($product->amount <= 0) disabled @endif" onclick="fastSetAmountButton('{{ $product->id }}', false)">
